...
const urlsToCache = [
  ...
  '/eliglownails/admin.html',
  '/eliglownails/admin-login.html',
  '/eliglownails/calendar.html',
  '/eliglownails/setup-wizard.html',
  '/eliglownails/editar-negocio.html',
  '/eliglownails/manifest.json',
  '/eliglownails/icons/icon-72x72.png',
  '/eliglownails/icons/icon-96x96.png',
  '/eliglownails/icons/icon-128x128.png',
  '/eliglownails/icons/icon-144x144.png',
  ...
  '/eliglownails/utils/push-config.js',
  '/eliglownails/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/eliglownails/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/eliglownails/icons/icon-192x192.png',
    badge: '/eliglownails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/eliglownails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/eliglownails/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para EliGlow Nails');
